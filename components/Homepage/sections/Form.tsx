    ...
    return (
        <div className=' w-[100vw] h-[100vh] flex items-center justify-center'>
            <form action="" className=' w-[90%] lg:w-[60%]'>
                ...
                <textarea name="" id="" cols={30} rows={10} className=' p-2 border-2 border-[#010438] w-full rounded-xl focus:outline-none mb-[10px] resize-none' placeholder='Enter Your Message'></textarea>
